...
public final class AccountWorldbossesEndpoint {

    private Gw2ApiClient gw2ApiClient;
    private String endpointUrl = Gw2ApiEndpointUrl.V2.ACCOUNT.WORLD_BOSSES.getUrl();

    public AccountWorldbossesEndpoint(Gw2ApiClient gw2ApiClient) {
        this.gw2ApiClient = gw2ApiClient;
    }

    public CompletableFuture<List<String>> getDailyCompleteWorldBossIds() {
