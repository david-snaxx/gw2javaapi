...
public final class AccountDailyCraftingEndpoint {

    private Gw2ApiClient gw2ApiClient;
    private String endpointUrl = Gw2ApiEndpointUrl.V2.ACCOUNT.DAILY_CRAFTING.getUrl();

    public AccountDailyCraftingEndpoint(Gw2ApiClient gw2ApiClient) {
        this.gw2ApiClient = gw2ApiClient;
    }

    public CompletableFuture<List<String>> getCraftedDailyItems() {
